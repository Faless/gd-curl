def build_library(env):
    ...
    nghttp2_config = {
        ...
        "CMAKE_DISABLE_FIND_PACKAGE_Libngtcp2": 1,
        "CMAKE_DISABLE_FIND_PACKAGE_Libnghttp3": 1,
        "CMAKE_DISABLE_FIND_PACKAGE_Systemd": 1,
        "CMAKE_DISABLE_FIND_PACKAGE_Jansson": 1,
        "CMAKE_DISABLE_FIND_PACKAGE_Libevent": 1,
        "CMAKE_DISABLE_FIND_PACKAGE_LibXml2": 1,
